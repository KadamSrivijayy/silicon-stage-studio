  ...
  head: () => ({
    meta: [
      ...
      { title: "Srivijay Kadam | Aspiring Software Developer" },
      {
        name: "description",
        content:
          "Portfolio of Srivijay Kadam, a student developer focused on C++, DSA and problem solving.",
      },
      { name: "author", content: "Srivijay Kadam" },
      { property: "og:site_name", content: "Srivijay Kadam" },
